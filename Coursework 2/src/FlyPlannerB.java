...
public interface FlyPlannerB<A extends AirportA, F extends Flight> {
	 ...
	 */
	Set<AirportImpl> getBetterConnectedInOrder(AirportImpl airport);

	/**
	 * Returns the airport code of a best airport for the meet up of two people
	 * located in two different airports (airport codes) accordingly to the trips
	 * costs. The meet-up should be different than the two stating airports.
	 */
	String leastCostMeetUp(String at1, String at2) throws FlyPlannerException;
	 ...
	 * airports.
	 */
	String leastHopMeetUp(String at1, String at2) throws FlyPlannerException;
	 ...
	 */
	String leastTimeMeetUp(String at1, String at2, String startTime) throws FlyPlannerException;
